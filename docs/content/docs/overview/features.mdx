...
- The Canvas BFF now provides the account/session/provider/project/asset/generation contract and Sub2API SSO handoff, but the default frontend still needs remote-first project hydration and generation adapter wiring before it can replace the local workbench path.
