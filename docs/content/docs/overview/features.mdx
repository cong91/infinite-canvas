...
- The checked-in BFF currently uses in-memory repositories and injectable worker/provider boundaries for contract validation; PostgreSQL, S3-compatible object storage, production provider adapters and deployment topology remain pending.
